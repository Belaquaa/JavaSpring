...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.vovandrelo.spring_7_AOP.less_7_pointcut.Library.get*(..))")
    private void allGetMethodsFromLibrary() {
    }
    @Pointcut("execution(* com.vovandrelo.spring_7_AOP.less_7_pointcut.Library.return*(..))")
